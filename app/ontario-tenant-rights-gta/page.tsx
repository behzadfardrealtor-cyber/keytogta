...
export default function OntarioTenantRightsPage() {
  return (
    <main className="min-h-screen bg-[#F7F7F2] text-[#17313A]">
      ...
      <header className="sticky top-0 z-50 border-b border-[#E8E4DD] bg-white/88 px-6 py-5 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6">
          ...
          <nav className="hidden items-center gap-7 text-sm text-[#17313A]/72 md:flex">
            <a href="#rent-increase" className="hover:text-[#17313A]">
              Rent Increases
            </a>
            <a href="#rent-control" className="hover:text-[#17313A]">
              Rent Control
            </a>
            <a href="#deposits" className="hover:text-[#17313A]">
              Deposits
            </a>
            <a href="#entry-rules" className="hover:text-[#17313A]">
              Entry Rules
            </a>
      ...
      <section id="rent-increase" className="bg-[#DCE8E3] px-6 py-20 text-[#17313A]">
        <div className="mx-auto max-w-7xl">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.25em] text-[#2F6F6B]">
            Rent Increases
          </p>
      ...
      <section id="rent-control" className="bg-white px-6 py-20 text-[#17313A]">
        <div className="mx-auto max-w-7xl">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.25em] text-[#2F6F6B]">
            Rent Control
          </p>
      ...
      <section id="deposits" className="bg-[#DCE8E3] px-6 py-20 text-[#17313A]">
        <div className="mx-auto max-w-7xl">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.25em] text-[#2F6F6B]">
            Deposits
          </p>
          ...
          <div className="mt-10 rounded-[2rem] border border-[#2F6F6B]/25 bg-white p-8">
            ...
            <div className="mt-5 grid gap-4">
              {unpaidInterestSteps.map((step, index) => (
                <div key={step} className="flex gap-4">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#2F6F6B] font-bold text-white">
                    {index + 1}
                  </span>
                  <p className="leading-7 text-[#17313A]/85">{step}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="entry-rules" className="bg-white px-6 py-20 text-[#17313A]">
        <div className="mx-auto max-w-7xl">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.25em] text-[#2F6F6B]">
            Entry Rules
          </p>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {entryRules.map((item) => (
              <article key={item.title} className="rounded-[2rem] bg-[#F7F7F2] p-6">
                <h3 className="text-xl font-bold">{item.title}</h3>
                <p className="mt-3 leading-7 text-[#17313A]/72">{item.detail}</p>
              </article>
            ))}
      ...
      <section id="notice-requirements" className="bg-[#DCE8E3] px-6 py-20 text-[#17313A]">
        <div className="mx-auto max-w-7xl">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.25em] text-[#2F6F6B]">
      ...
      <section id="ltb" className="bg-[#DCE8E3] px-6 pb-20 text-[#17313A]">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[2rem] border border-[#E8E4DD] bg-white p-8 md:p-10">
            ...
            <p className="mt-4 max-w-3xl text-sm font-semibold uppercase tracking-[0.16em] text-[#17313A]/68">
            ...
            <ul className="mt-3 max-w-3xl space-y-2">
              {ltbReasons.map((reason) => (
                <li
                  key={reason}
                  className="flex gap-3 leading-7 text-[#17313A]/72"
                >
