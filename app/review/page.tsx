...
export default function ReviewPage() {
  return (
    <main className="relative isolate flex h-[100svh] min-h-[100svh] items-center justify-center overflow-hidden bg-[#050816] px-4 py-2 text-[#f8fafc] sm:py-4">
      ...
      <section
        ...
        className="relative h-[calc(100svh-16px)] max-h-[680px] w-full max-w-[1180px] overflow-hidden rounded-[28px] border border-[#d6b36a]/25 bg-[#070e1b]/82 px-4 py-3 shadow-[0_28px_90px_rgba(0,0,0,0.58),0_0_42px_rgba(214,179,106,0.14),0_0_38px_rgba(72,111,205,0.20),inset_0_1px_0_rgba(255,255,255,0.10)] backdrop-blur-xl sm:h-[calc(100svh-32px)] sm:px-8 sm:py-5 lg:px-10 lg:py-6"
      >
        ...
        <div className="relative z-20 flex h-full min-h-0 flex-col overflow-y-auto lg:w-[58%]">
          ...
          <div className="mt-2 max-w-2xl sm:mt-4 lg:mt-5">
            <div
              aria-hidden="true"
              className="mb-1 flex items-center gap-1 text-base leading-none text-[#f0c76a] sm:mb-2 sm:text-xl"
            >
              <span>★</span>
              <span>★</span>
              <span>★</span>
            ...
            <h1
              id="review-heading"
              className="text-[1.55rem] font-semibold leading-[1.05] tracking-tight text-white sm:text-[clamp(1.9rem,7vw,2.75rem)] sm:leading-[0.98] lg:text-4xl xl:text-5xl"
            >
            ...
            <p className="mt-1.5 max-w-[38rem] text-xs leading-4 text-[#d9e2ef] sm:mt-2.5 sm:text-sm sm:leading-5 lg:text-[0.95rem]">
          ...
          <div className="mt-3 flex flex-col gap-3 sm:mt-4 sm:flex-row sm:gap-4">
            <a
              className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[#f0c76a] px-6 text-sm font-bold text-[#09111d] shadow-[0_0_34px_rgba(240,199,106,0.36)] transition hover:bg-[#ffd978] hover:shadow-[0_0_46px_rgba(240,199,106,0.48)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f0c76a] sm:h-12 sm:px-7"
          ...
          <div className="mt-3 shrink-0 sm:mt-4">
            <p className="border-t border-white/10 pt-1.5 text-center text-[0.62rem] font-bold uppercase tracking-[0.2em] text-[#f0c76a]/90 sm:pt-2 sm:text-[0.68rem] sm:tracking-[0.3em]">
              REVIEW GUIDE
            </p>
            <div className="mt-1.5 grid gap-1.5 sm:mt-2 sm:grid-cols-3 sm:gap-2">
              {reviewCards.map((card) => (
                <article
                  className="h-14 rounded-2xl border border-white/10 bg-white/[0.055] px-2.5 py-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_16px_34px_rgba(0,0,0,0.18)] sm:h-20 sm:px-3 sm:py-2"
                  key={card.number}
                >
          ...
          <footer className="mt-3 flex shrink-0 flex-col items-center justify-center gap-1 pt-2 text-center text-xs text-[#d9e2ef] sm:mt-4 sm:pt-3 sm:flex-row sm:text-sm">
